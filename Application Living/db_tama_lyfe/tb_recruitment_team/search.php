...
if($_SERVER['REQUEST_METHOD']=='POST') {
  $search_recruitment_team = $_POST['search_recruitment_team'];
  $sql = "SELECT * FROM tb_recruitment_team where name_team LIKE '%$search_recruitment_team%' 
  ORDER BY name_team ASC";
