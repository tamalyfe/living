package com.example.living.userInterface.mainPage.homePage.adapter;
...
public class HomePageProjectNewAdapter extends RecyclerView.Adapter<HomePageProjectNewAdapter.ViewHolder> {
    private Context context;
    private List<ItemResponseProject> list;

    public HomePageProjectNewAdapter(Context context, List<ItemResponseProject> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public HomePageProjectNewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_page_project_new_adapter, parent, false);
        HomePageProjectNewAdapter.ViewHolder holder = new HomePageProjectNewAdapter.ViewHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(HomePageProjectNewAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        @BindView(R.id.tvIdentifierProject)
        TextView tvIdentifierProject;
