...
public class DetailProjectPageAdapter extends RecyclerView.Adapter<DetailProjectPageAdapter.ViewHolder> {
    private Context context;
    private List<ItemResponseRequestCustomer> list;

    public DetailProjectPageAdapter(Context context, List<ItemResponseRequestCustomer> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public DetailProjectPageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detail_project_page_adapter, parent, false);
        DetailProjectPageAdapter.ViewHolder holder = new DetailProjectPageAdapter.ViewHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(DetailProjectPageAdapter.ViewHolder holder, int position) {
        ...
        holder.tvDescriptionRequestCustomer.setText(result.getDescriptionRequestCustomer());  holder.tvDescriptionRequestCustomer.setVisibility(View.GONE);
